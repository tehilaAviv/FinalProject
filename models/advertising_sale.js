...
module.exports = (sequelize, DataTypes) => {
  class Advertising_sale extends Model {
    /**
    ...
    static associate(models) {
      Advertising_sale.belongsTo(models.Users,{foreignKey:{allowNull:false}})
      // define association here
    }
  };
  Advertising_sale.init({
    ...
    sequelize,
    modelName: 'Advertising_sale',
  });
  return Advertising_sale;
};